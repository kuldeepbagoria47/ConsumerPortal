    ...
    <div className="bg-white border-b border-gray-200">
      ...
      <div className="bg-gray-100 px-4 py-1 flex items-center justify-between text-xs text-gray-600">
        <div className="flex items-center gap-2">
          ...
          <span className="ml-4">genus.dashboard.in</span>
        </div>
      ...
      <div className="px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <h1 className="text-xl font-semibold text-gray-800">Good Morning! Super Admin</h1>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-green-500 rounded-full"></div>
            <span className="text-sm text-gray-600">Active</span>
          </div>
          <div className="text-sm text-gray-500">
            Last Refresh: 2 min ago | Last update: 11.11.2025, 14:25:05
          </div>
        </div>
        <div className="flex items-center gap-4">
          <div className="relative">
            <input
              type="text"
              placeholder="Try searching zone name here"
